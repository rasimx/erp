...
export class Init1717007045071 implements MigrationInterface {
    name = 'Init1717007045071'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "sku" character varying NOT NULL, "width" integer NOT NULL, "height" integer NOT NULL, "length" integer NOT NULL, "weight" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_date" TIMESTAMP, CONSTRAINT "UQ_34f6ca1cd897cc926bdcca1ca39" UNIQUE ("sku"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."operation_proportion_type_enum" AS ENUM('equal', 'manual', 'weight', 'volume', 'costPrice')`);
        await queryRunner.query(`CREATE TABLE "operation" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "cost" integer NOT NULL, "date" character varying NOT NULL, "proportion_type" "public"."operation_proportion_type_enum" NOT NULL DEFAULT 'equal', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_date" TIMESTAMP, CONSTRAINT "PK_18556ee6e49c005fc108078f3ab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_batch_operation" ("id" SERIAL NOT NULL, "proportion" double precision NOT NULL, "cost" integer NOT NULL, "product_batch_id" integer NOT NULL, "operation_id" integer NOT NULL, CONSTRAINT "PK_44c0226eeb6603ca05b8669a7cd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "status" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_date" TIMESTAMP, CONSTRAINT "PK_e12743a7086ec826733f54e1d95" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "product_batch" ("id" SERIAL NOT NULL, "product_id" integer NOT NULL, "status_id" integer NOT NULL, "parent_id" integer, "count" integer NOT NULL, "count_updated" boolean NOT NULL DEFAULT false, "cost_price" integer NOT NULL, "date" date NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_date" TIMESTAMP, CONSTRAINT "PK_dfd61dce60415e9b7acd2321b3a" PRIMARY KEY ("id"))`);
