...
import MergeProductBatchForm from './MergeProductBatchForm';
...
const MergeProductBatchModal: FC<Props> = ({}) => {
...
export default MergeProductBatchModal;
