...
export type ProductBatchListQuery = { __typename?: 'Query', productBatchList: Array<{ __typename?: 'ProductBatch', id: number, parentId?: number | null, statusId: number, count: number, pricePerUnit: number, costPrice: number, fullPrice: number, date: string, weight: number, volume: number, product: { __typename?: 'Product', sku: string, name: string } }> };
...
export type UpdateProductBatchMutation = { __typename?: 'Mutation', updateProductBatch: { __typename?: 'ProductBatch', id: number, parentId?: number | null, statusId: number, count: number, pricePerUnit: number, costPrice: number, fullPrice: number, date: string, weight: number, volume: number, product: { __typename?: 'Product', sku: string, name: string } } };
...
export type CreateProductBatchMutation = { __typename?: 'Mutation', createProductBatch: { __typename?: 'ProductBatch', id: number, parentId?: number | null, statusId: number, count: number, pricePerUnit: number, costPrice: number, fullPrice: number, date: string, weight: number, volume: number, product: { __typename?: 'Product', sku: string, name: string } } };
...
export type SplitProductBatchMutation = { __typename?: 'Mutation', splitProductBatch: { __typename?: 'SplitProductBatchResponse', newItems: Array<{ __typename?: 'ProductBatch', id: number, statusId: number, count: number, pricePerUnit: number, costPrice: number, fullPrice: number, date: string, weight: number, volume: number, product: { __typename?: 'Product', sku: string, name: string } }> } };
