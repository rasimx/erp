...
export type ProductBatchDetailFragment = { __typename?: 'ProductBatchDetailDto', id: number, name: string, groupId?: number | null, productId: number, parentId?: number | null, statusId?: number | null, count: number, costPricePerUnit: number, operationsPricePerUnit: number, date: string, order: number, volume: number, weight: number, color: string, product: (
    { __typename?: 'ProductDto' }
...
export type ProductBatchFragment = { __typename?: 'ProductBatchDto', id: number, name: string, groupId?: number | null, productId: number, parentId?: number | null, statusId?: number | null, count: number, costPricePerUnit: number, operationsPricePerUnit: number, date: string, order: number, volume: number, weight: number, color: string, product: (
    { __typename?: 'ProductDto' }
    & { ' $fragmentRefs'?: { 'ProductFragment': ProductFragment } }
