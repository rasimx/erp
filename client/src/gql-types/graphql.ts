...
export type QueryStoreStateArgs = {
  ...
  storeInput?: InputMaybe<StoreInput>;
};
...
export type ProductBatchListQuery = { __typename?: 'Query', productBatchList: Array<(
    { __typename?: 'ProductBatch' }
    & { ' $fragmentRefs'?: { 'ProductBatchInStatusFragment': ProductBatchInStatusFragment } }
  )> };

export type ProductBatchInStatusFragment = { __typename?: 'ProductBatch', id: number, name: string, parentId?: number | null, statusId?: number | null, count: number, pricePerUnit: number, costPrice: number, fullPrice: number, date: string, weight: number, volume: number, product: { __typename?: 'Product', sku: string, name: string } } & { ' $fragmentName'?: 'ProductBatchInStatusFragment' };
...
export type UpdateProductBatchMutation = { __typename?: 'Mutation', updateProductBatch: (
    { __typename?: 'ProductBatch' }
    & { ' $fragmentRefs'?: { 'ProductBatchInStatusFragment': ProductBatchInStatusFragment } }
  ) };
...
export type CreateProductBatchMutation = { __typename?: 'Mutation', createProductBatch: (
    { __typename?: 'ProductBatch' }
    & { ' $fragmentRefs'?: { 'ProductBatchInStatusFragment': ProductBatchInStatusFragment } }
  ) };
...
export type SplitProductBatchMutation = { __typename?: 'Mutation', splitProductBatch: { __typename?: 'SplitProductBatchResponse', newItems: Array<(
      { __typename?: 'ProductBatch' }
      & { ' $fragmentRefs'?: { 'ProductBatchInStatusFragment': ProductBatchInStatusFragment } }
    )> } };
...
export const StoreStateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"storeState"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"productId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"storeInput"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"StoreInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"storeState"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"productId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"productId"}}},{"kind":"Argument","name":{"kind":"Name","value":"storeInput"},"value":{"kind":"Variable","name":{"kind":"Name","value":"storeInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"items"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"StoreItem"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"StoreItem"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StoreByProduct"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"salesCount"}},{"kind":"Field","name":{"kind":"Name","value":"inStoreCount"}},{"kind":"Field","name":{"kind":"Name","value":"productBatches"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"count"}},{"kind":"Field","name":{"kind":"Name","value":"pricePerUnit"}},{"kind":"Field","name":{"kind":"Name","value":"costPrice"}},{"kind":"Field","name":{"kind":"Name","value":"fullPrice"}},{"kind":"Field","name":{"kind":"Name","value":"date"}}]}},{"kind":"Field","name":{"kind":"Name","value":"product"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"sku"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<StoreStateQuery, StoreStateQueryVariables>;