...
export type Mutation = {
  ...
  revert: CommandResponse;
  rollback: CommandResponse;
};
...
export type RollbackMutationVariables = Exact<{ [key: string]: never; }>;


export type RollbackMutation = { __typename?: 'Mutation', rollback: { __typename?: 'CommandResponse', success: boolean } };

export type RevertMutationVariables = Exact<{ [key: string]: never; }>;


export type RevertMutation = { __typename?: 'Mutation', revert: { __typename?: 'CommandResponse', success: boolean } };
...
export const RevertDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"revert"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"revert"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}}]}}]}}]} as unknown as DocumentNode<RevertMutation, RevertMutationVariables>;
